...
export function printStyles(primary: string, accent: string): string {
  // Auf weißem Papier muss die Markenfarbe als Schrift lesbar bleiben; sehr
  // helle Töne werden dafür abgedunkelt. Flächen behalten die Originalfarbe
  // und bekommen eine passende Schriftfarbe.
...
h1 { font-size: 26pt; margin: 0 0 2mm; color: var(--primary-text); }
h2 { font-size: 15pt; margin: 8mm 0 3mm; color: var(--primary-text); }
...
.kopf .titel { flex: 1; }
.kopf .marke { font-weight: 900; font-size: 11pt; color: var(--primary-text); }
